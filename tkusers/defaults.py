...
SOCIAL_AUTH_PIPELINE = (
    ...
    'tkusers.pipeline.ensure_uuid_match',

    # Generate username from UUID
    'tkusers.pipeline.get_username',

    # Checks if the current social-account is already associated in the site.
    'social_core.pipeline.social_auth.social_user',

    # Get or create the user and update user data
    'tkusers.pipeline.create_or_update_user',
    ...
    'tkusers.pipeline.store_end_session_url',

    # If the access token gives access to external APIs, fetch the
    # API tokens here.
    'tkusers.pipeline.fetch_api_tokens',
)
