...
class TurkuOAuth2Adapter(OAuth2Adapter):
    ...
    access_token_url = 'https://testitunnistamo.turku.fi/sso/oauth2/token/'
    authorize_url = 'https://testitunnistamo.turku.fi/sso/oauth2/authorize/'
    profile_url = 'https://testitunnistamo.turku.fi/sso/user/'
