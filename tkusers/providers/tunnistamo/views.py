...
class TurkuOIDCOAuth2Adapter(OAuth2Adapter):
    ...
    access_token_url = 'https://testitunnistamo.turku.fi/openid/token/'
    authorize_url = 'https://testitunnistamo.turku.fi/openid/authorize/'
    profile_url = 'https://testitunnistamo.turku.fi/openid/userinfo/'
